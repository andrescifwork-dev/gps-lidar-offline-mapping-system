#FUNCIONA AL 100, MAS IMPLEMENTACION DE ALARMA MEDIA Y CONDICIONAL DE VELOCIDAD.
...
def update_map(latitud, longitud, vel, rumbo, distancia_laser):
    try:
        ...
        global alarma_activa2

        #print(distancia_laser)
        #print(vel)

        # Actualizar la posición del marcador del obstáculo (si hay obstáculo)
        #RECUERDA CAMBIAR LA VELOCIDAD
        if distancia_laser > 6000 and distancia_laser <= 8000 and vel >= 0:
            ...
            if not alarma_activa:
                alarma_activa = True
                winsound.PlaySound('alarma2.wav', winsound.SND_FILENAME | winsound.SND_ASYNC)


        #CONDICIONAL 2
        # Actualizar la posición del marcador del obstáculo (si hay obstáculo)
        #RECUERDA CAMBIAR LA VELOCIDAD
        if distancia_laser > 300 and distancia_laser <= 5000 and vel >= 0:
            # Calcular la posición del marcador del obstáculo en función de la dirección del auto y la distancia
            latitud_obstaculo = latitud + distancia_laser * 0.00001
            longitud_obstaculo = longitud
        ...
        #CONDICIONAL 2
            ...
            if alarma_activa or alarma_activa2:
                alarma_activa = False
                alarma_activa2 = False
